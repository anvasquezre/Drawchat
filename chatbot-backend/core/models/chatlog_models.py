...
from core.models.base_model import BaseDTO, generate_id as generate_uuid,generate_date_str


class SessionBase(BaseDTO):
    """
    ...
    Example Usage:
        ...
        session_data = SessionBase(
            ...
            metadata="Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/118.0.0.0 Safari/537.36"
    ...
    """
    created_at: Optional[str] = Field(default_factory=generate_date_str)
...
class SessionCreate(SessionBase):
    ...
    Attributes:
        - session_id (str): A unique identifier for the session. It is generated using
          the `generate_uuid` function by default.
...
class MessageBase(BaseDTO):
    ...
    """
    created_at: Optional[str] = Field(default_factory=generate_date_str, alias="timestamp")
    exchange: Optional[str] = Field(default=None, alias="text")
    message_type: Optional[str] = Field(default=None, alias="user")
...
class MessageCreate(MessageBase):
    ...
    Attributes:
        - message_id (Optional[str]): A unique identifier for the message. It is generated
          using the `generate_uuid` function by default.
    ...
    """
    message_id: Optional[str] = Field(default_factory=generate_uuid, alias="messageID")
...
class FeedbackBase(BaseDTO):
    ...
    created_at: Optional[datetime] = Field(default_factory=generate_date_str)
...
class FeedbackCreate(FeedbackBase):
    ...
    Attributes:
        - feedback_id (Optional[str]): A unique identifier for the feedback. It is
          generated using the `generate_uuid` function by default.
    ...
    feedback_id: Optional[str] = Field(default_factory=generate_uuid)
...
class TicketCreate(TicketBase):
    ...
    ticket_id: Optional[str] = Field(default_factory=generate_uuid)
